  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 py-8">
      ...
      <div className="prose prose-slate dark:prose-invert lg:prose-xl">
        <p>
          News Era is a premier news platform dedicated to bringing you the most relevant updates in Technology and Cybersecurity.
        </p>
        <p>
        ...
        <p>
          We aim to publish 3 essential posts every single day, ensuring you stay informed without being overwhelmed. Whether it's a major tech breakthrough or a critical security vulnerability, News Era has you covered.
        </p>
      </div>
    </div>
  );
